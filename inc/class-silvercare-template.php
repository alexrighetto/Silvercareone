...
if ( ! class_exists( 'Silvercare_Template' ) ) {

class Silvercare_Template {
	...
	public function __construct() {
		...
		add_action( 'silvercare_before_homepage_content', 'storefront_homepage_content', 					10 );
		add_action( 'silvercare_before_homepage_content', 'storefront_featured_products',					20 );
	...
	public function primary_navigation_wrapper() {
		echo '<section class="silvercare-primary-navigation">';
	}
...
return new Silvercare_Template();