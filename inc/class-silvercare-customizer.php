...
if ( ! class_exists( 'Silvercare_Customizer' ) ) {

class Silvercare_Customizer {
	...
	public function __construct() {
		...
		add_filter( 'storefront_setting_default_values', array( $this, 'get_Silvercare_defaults' ) );
	 ...
	 * @return array
	 */
	public function get_silvercare_defaults() {
		return apply_filters( 'silvercare_default_settings', $args = array(
			'storefront_heading_color'               => '#2b2b2b',
			'storefront_footer_heading_color'        => '#cccccc',
			...
			'storefront_header_text_color'           => '#595959',
			'storefront_button_alt_text_color'       => '#595959',
			'storefront_footer_link_color'           => '#111111',
			'storefront_text_color'                  => '#777777',
			'storefront_footer_text_color'           => '#777777',
			'storefront_accent_color'                => '#1e73be',
			'storefront_button_alt_background_color' => '#3faa39',
	 ...
	 * @uses get_silvercare_defaults()
	 * @return void
	 */
	public function edit_default_customizer_settings( $wp_customize ) {
		foreach ( Silvercare_Customizer::get_silvercare_defaults() as $mod => $val ) {
	...
	public function default_theme_settings() {
		...
		foreach ( self::get_silvercare_defaults() as $mod => $val) {
...
return new Silvercare_Customizer();